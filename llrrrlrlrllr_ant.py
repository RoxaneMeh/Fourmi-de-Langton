...
class App():
    def __init__(self,WIDTH=1375,HEIGHT=715,CELL_SIZE=6,COLOR=(0,0,0),SPEED=100000000):
        pygame.init()
        ...
        self.ant = Ant(app=self, pos=[self.COLS//3,self.ROWS//2],color=color[1]) 
